...
- 🔄 **Automated Updates**: Container updates via GitHub webhooks (via Dependabot) & image tag updates via schedule
...
services:
  containers-up:
    ...
    image: ghcr.io/digitallyrefined/containers-up:0.0.7
    restart: always
    ports:
      - 3000:3000
      - 3001:3001
